...
public class Audience {
    ...
    public void buyTicket(TicketSeller seller) {ticket = seller.getTicket(this);}

    public boolean hasAmount(Long amount) {return this.amount >= amount;}
    ...
    public void removeInvitation() {invitation = Invitation.EMPTY;}
